<x-app-layout>
    ...
    {{-- @dd(request()->routeIs('transaksi.in')) --}}

    <div class="flex flex-row-reverse">
        <a href="{{route('scan.in')}}"><button  type="button" hr class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Tambah Barang Masuk</button></a>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 ">
                            ...
                            <div class="flex justify-center items-center">
                                ...
                                {{-- <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#75FB4C"><path d="M440-160v-487L216-423l-56-57 320-320 320 320-56 57-224-224v487h-80Z"/></svg> --}}
                            </div>
                            {{-- {{ $transaction->quantity }}<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#75FB4C"><path d="M440-160v-487L216-423l-56-57 320-320 320 320-56 57-224-224v487h-80Z"/></svg> --}}
                        </td> 
                        <td class="px-6 py-4  ">
